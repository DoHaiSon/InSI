function Br_angle_Theta= SEMI_spec_chan_derive_angle_Theta_UCyA(fading,delay,DOA_Phi,DOA_Theta,position_elements_nor, lambda,L,M,Nt)
    ...
    for mm = 1 : M
        for l = 1 : L
            ...
            Br_angle_Theta_tmp(mm,l,jj)=fading(mm,jj)*sinc((l-1)-delay(mm,jj)) ...
                ...
                * (-1i*2*pi)/lambda *( position_elements_nor(1) * cos(DOA_Theta(mm,jj)) * cos(DOA_Phi(mm,jj)) + ...
