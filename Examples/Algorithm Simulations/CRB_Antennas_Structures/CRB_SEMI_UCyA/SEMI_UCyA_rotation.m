...
position_elements_nor = zeros(3, Nr_UCA, Nr_ULA);
...
[H, h_true] = gen_chan_specular_rotation(fading,delay,DOA_Phi,DOA_Theta,position_elements_nor,R_nor,d_ULA_nor,Nr_UCA,Nr_ULA,L,Nt, rot_nor);
