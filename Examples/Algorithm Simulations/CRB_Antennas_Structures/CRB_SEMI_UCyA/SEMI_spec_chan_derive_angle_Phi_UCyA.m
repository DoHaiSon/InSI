function Br_angle_Phi= spec_chan_derive_angle_Phi(fading,delay,DOA_Phi,DOA_Theta,UCA_nor,R_nor,d_ULA_nor,Nr_UCA_index,Nr_ULA_index,Nr_UCA,Nr_ULA,L,M,Nt)
