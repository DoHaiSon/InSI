...
for Nr_index=1:Nr;
    Br_fading = SEMI_spec_chan_derive_fading_UCA3D(fading,delay,DOA_Phi,DOA_Theta,R_nor,Nr_index,Nr,L,M,Nt);
    dev_h_fading=[dev_h_fading; transpose(Br_fading)];

    Br_delay = SEMI_spec_chan_derive_delay_UCA3D(fading,delay,DOA_Phi,DOA_Theta,R_nor,Nr_index,Nr,L,M,Nt);
    dev_h_delay=[dev_h_delay; transpose(Br_delay)];

    Br_angle_Phi = SEMI_spec_chan_derive_angle_Phi_UCA3D(fading,delay,DOA_Phi,DOA_Theta,R_nor,Nr_index,Nr,L,M,Nt);
    dev_h_angle_Phi=[dev_h_angle_Phi; transpose(Br_angle_Phi)];

    Br_angle_Theta = SEMI_spec_chan_derive_angle_Theta_UCA3D(fading,delay,DOA_Phi,DOA_Theta,R_nor,Nr_index,Nr,L,M,Nt);
...
[H, h_true] = gen_chan_specular(fading,delay,DOA_Phi,DOA_Theta,R_nor,Nr,L,Nt);
