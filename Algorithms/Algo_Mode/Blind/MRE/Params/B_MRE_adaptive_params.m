classdef B_MRE_adaptive_params
    ...
    properties
        ...
        values = {1000, 4, 4, {'Real', 'Complex', 'Input'}, {'Binary', 'QPSK', '4-QAM', '16-QAM', '64-QAM', '128-QAM', '256-QAM'}, 10, 0.001}
        default_values = {1000, 4, 4, 2, 2, 10, 0.001}
        ...
        % Triggers/Flags
        has_inter     = [true, true, false, false, false, false, false]
        rect = {}
        rect_position = {[430 940 110 110], [1240 1205 265 80], 0, 0, 0, 0, 0}
        rect_linewidth = {2, 2, 0, 0, 2, 0, 0}
        rect_color     = {'b', 'r', 'b', 'b', 'r', 'b', 'b'}  
