classdef B_GRDA_params
    ...
    properties
        ...
        values = {10000, 4, 4, {'Real', 'Complex', 'Parametric', 'Input'}, {'Binary', 'QPSK', '4-QAM', '16-QAM', '64-QAM', '128-QAM', '256-QAM'}, 10}
        ...
        % Reference website
        web_url = 'https://ieeexplore.ieee.org/document/1003068'
    end
