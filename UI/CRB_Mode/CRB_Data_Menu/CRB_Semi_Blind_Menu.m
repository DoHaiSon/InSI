function varargout = CRB_Semi_Blind_Menu(varargin)
% CRB_SEMI_BLIND_MENU MATLAB code for CRB_Semi_Blind_Menu.fig
%      CRB_SEMI_BLIND_MENU, by itself, creates a new CRB_SEMI_BLIND_MENU or raises the existing
%      singleton*.
%
%      H = CRB_SEMI_BLIND_MENU returns the handle to a new CRB_SEMI_BLIND_MENU or the handle to
%      the existing singleton*.
%
%      CRB_SEMI_BLIND_MENU('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in CRB_SEMI_BLIND_MENU.M with the given input arguments.
%
%      CRB_SEMI_BLIND_MENU('Property','Value',...) creates a new CRB_SEMI_BLIND_MENU or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before CRB_Semi_Blind_Menu_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to CRB_Semi_Blind_Menu_OpeningFcn via varargin.
%
...
% Last Modified by GUIDE v2.5 30-Sep-2022 15:37:50
...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_OpeningFcn', @CRB_Semi_Blind_Menu_OpeningFcn, ...
                   'gui_OutputFcn',  @CRB_Semi_Blind_Menu_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before CRB_Semi_Blind_Menu is made visible.
function CRB_Semi_Blind_Menu_OpeningFcn(hObject, eventdata, handles, varargin)
...
% Choose default command line output for CRB_Semi_Blind_Menu
...
function varargout = CRB_Semi_Blind_Menu_OutputFcn(hObject, eventdata, handles) 
...
% handles    structure with handles and user data (see GUIDATA)
    ...
    algo = strcat('SB_', methods{method});
    load_funcs(hObject, eventdata, handles, 'CRB_Mode', 'Semi-blind', algo);
...
% handles    structure with handles and user data (see GUIDATA)
    ...
    algo = strcat('SB_', methods{method});
    load_reactive(hObject, eventdata, handles, 'CRB_Mode', 'Semi-blind', algo);
