...
% Last Modified by GUIDE v2.5 03-Jun-2023 22:18:32
...
% varargin   command line arguments to Algo_Semi_Blind_Menu (see VARARGIN)
    ...
    global main_path;
    jFrame=get(handle(handles.InSI_A_SB), 'javaframe');
...
% handles    structure with handles and user data (see GUIDATA)
    ...
    vers = load_versions('Algo_Mode', 'Semi-blind', default, methods{method});
